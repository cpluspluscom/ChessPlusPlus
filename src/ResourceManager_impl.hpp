...
namespace chesspp
{
    ...
    {
        ResourceManager_impl(ResourceManager_impl const &) = delete;
        ResourceManager_impl &operator=(ResourceManager_impl const &) = delete;
    ...
    protected:
        ResourceManager_impl() = default;
        ResourceManager_impl(ResourceManager_impl &&) = default;
        ResourceManager_impl &operator=(ResourceManager_impl &&) = default;
        ~ResourceManager_impl() = default;
