...
namespace chesspp
{
    namespace gfx
    {
        ...
        , gfx_config(gfxc)
        , board_config(bc)
        , board        (TextureManager.load(gfx_config.spritePath("board", "board"        )))
        , valid_move   (TextureManager.load(gfx_config.spritePath("board", "valid move"   )))
        , enemy_move   (TextureManager.load(gfx_config.spritePath("board", "enemy move"   )))
        , valid_capture(TextureManager.load(gfx_config.spritePath("board", "valid capture")))
        , enemy_capture(TextureManager.load(gfx_config.spritePath("board", "enemy capture")))
        {
        }
        ...
        {
            sf::Sprite piece {TextureManager.load(p.texture())};
